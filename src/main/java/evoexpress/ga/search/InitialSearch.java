...
public class InitialSearch extends GeneticAlgorithm {
    ...
    public InitialSearch(Set<Mutator> mutators, FitnessFunction fitnessFunction, int maxPopulationSize, double mutationRate, double crossoverRate, int elitismCount) {
