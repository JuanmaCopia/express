...
public class TraverseCircularReferenceProcessor extends AbstractProcessor<CtBlock<?>> {
    ...
    public void process(CtBlock<?> ctBlock) {
        ...
        CtExpression<Boolean> currentNullComp = SpoonFactory.createNullComparisonClause(currentRead, BinaryOperatorKind.NE);
        ...
        CtExpression<Boolean> nullCompLoopField = SpoonFactory.createNullComparisonClause(SpoonFactory.createFieldRead(currentDeclaration, loopField), BinaryOperatorKind.EQ);
