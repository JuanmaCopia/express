...
public abstract class AbstractMap<K, V> implements Map<K, V> {
     ...
     * {@link Entry#hashCode hashCode()} on each element (entry) in
     * the
     ...
     * @apiNote This class facilitates the process of building custom map
     ...
     * @param <V> the type of the value
     * @apiNote Instances of this class are not necessarily immutable, as the key
     ...
     * as a subclass may be modifiable or may provide the appearance of
     * modifiability.
     * <p>
     * This class may be convenient in methods that return thread-safe
     * snapshots of
     * key-value mappings. For alternatives, see the
     * {@link Map#entry Map::entry} and {@link Entry#copyOf
     * Map.Entry::copyOf}
     * methods.
     * @since 1.6
     */
