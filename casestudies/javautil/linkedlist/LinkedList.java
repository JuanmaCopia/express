...
public class LinkedList<E>
    ...
    // this list.
    // * In addition, modifications to this list will be visible in the reversed
    // view.
    // *
    // * @return {@inheritDoc}
    // * @since 21
    ...
    // return new ReverseOrderLinkedListView<>(this, super.reversed(),
    ...
    // static class ReverseOrderLinkedListView<E> extends LinkedList<E> implements
    // java.io.Externalizable {
    // final LinkedList<E> list;
    // final List<E> rlist;
    // final Deque<E> rdeque;
    //
    // ReverseOrderLinkedListView(LinkedList<E> list, List<E> rlist, Deque<E>
    // rdeque) {
    // this.list = list;
    // this.rlist = rlist;
    // this.rdeque = rdeque;
